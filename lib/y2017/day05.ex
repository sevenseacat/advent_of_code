defmodule Y2017.Day05 do
  ...
  @doc """
  iex> Day05.next_jump(:array.from_list([0, 3, 0, 1, -3]), 0, &Day05.add_one/1)
  {:array.from_list([1, 3, 0, 1, -3]), 0}

  iex> Day05.next_jump(:array.from_list([1, 3, 0, 1, -3]), 0, &Day05.add_one/1)
  {:array.from_list([2, 3, 0, 1, -3]), 1}

  iex> Day05.next_jump(:array.from_list([2, 3, 0, 1, -3]), 1, &Day05.add_one/1)
  {:array.from_list([2, 4, 0, 1, -3]), 4}

  iex> Day05.next_jump(:array.from_list([2, 4, 0, 1, -3]), 4, &Day05.add_one/1)
  {:array.from_list([2, 4, 0, 1, -2]), 1}

  iex> Day05.next_jump(:array.from_list([2, 4, 0, 1, -2]), 1, &Day05.add_one/1)
