defmodule Y2022.Day20Test do
  ...
  test "verification, part 2", do: assert(Day20.part2_verify() == 4_090_409_331_120)
  ...
  test "next_position/1" do
    ...
    assert 0 == Day20.next_position(length: 7, item: -2, current: 2)
    ...
    # Position 6 and 0 in a list of 7 are fundamentally the same thing which
    # is why some of these numbers are weird
    ...
    assert 0 == Day20.next_position(length: 7, item: 7, current: 5)
    ...
    assert 0 == Day20.next_position(length: 7, item: -11, current: 5)
